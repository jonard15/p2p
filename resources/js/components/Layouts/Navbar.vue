    ...
    getMenus()
      {
        axios.get('permissions').then((response) =>{
          ...
          this.filteredMenuParents = data.filter(menu => menu.parent_id === 0 && menu.is_read === true && menu.isActive === 1);
          this.filteredMenuChilds = data.filter(menu => menu.parent_id && menu.is_read === true && menu.isActive === 1);
